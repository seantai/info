...
👀 [stats.js](https://github.com/mrdoob/stats.js/) is a library to **monitor the memory and performance** of your Three.js app, made by the creator of Three.js himself. Let's go ahead and install with `npm i stats.js`, **import**, **initialize** and **hook it** into our render loop.
...
❗❗ Keep in mind: Once we call `dispose()`, we need to **re-initialize** our viewer instance.❗❗
